...
class BB84Algorithm:
  ...
  def __generate_key(self, backend, original_bits_size, verbose,echAB,echAE,echEB,Y0B,Y0E,eE,eB,etaE,etaB,c,alpha):
  ...
  def run(self, message, backend, original_bits_size, measure_density, n_bits, verbose,echAB,echAE,echEB,Y0B,Y0E,eE,eB,etaE,etaB,c,alpha):
    ...
    alice, bob = self.__generate_key(backend, original_bits_size, verbose,echAB,echAE,echEB,Y0B,Y0E,eE,eB,etaE,etaB,c,alpha)
